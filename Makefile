...
test : plugin.so
	LD_PRELOAD=/usr/lib/libgtk-3.so:/usr/lib/libperl.so gcc-4.6 -fplugin=/home/mdupont/experiments/introspector/plugin/firstplugin/plugin.so -I$(GCCPLUGINS_DIR)/include  hello.c -c -o plugin-bootstrap.o

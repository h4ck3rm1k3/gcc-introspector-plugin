...
void field_type_TREE_CODE(tree t)
{
  ...
  /*     //generate process_enum_tree_code(t); */
  /*     // */
  /*     break; */
  /*   default: */
  /*     break; */
...
void field_type(tree t)
{
  ...
  */
  //  field_type_SWITCH_BODY(t); CRASH
  //  field_type_SWITCH_COND(t); CRASH
  //  field_type_SWITCH_LABELS(t);CRASH
  //  field_type_TARGET_EXPR_CLEANUP(t);CRASH
  field_type_TARGET_EXPR_INITIAL(t);
  //  field_type_TARGET_EXPR_SLOT(t);CRASH
  //  field_type_TMR_BASE(t);
  //field_type_TMR_INDEX(t); CRASH
  //  field_type_TMR_OFFSET(t);CRASH
  //  field_type_TMR_ORIGINAL(t);CRASH
  //  field_type_TMR_STEP(t);CRASH
  //  field_type_TMR_SYMBOL(t);CRASH
  field_type_TREE_ADDRESSABLE(t);
  field_type_TREE_ASM_WRITTEN(t);
  //  field_type_TREE_BLOCK(t);CRASH

...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 943,             /* -m128bit-long-double */
  OPT_m32 = 944,                             /* -m32 */
  OPT_m3dnow = 945,                          /* -m3dnow */
  OPT_m3dnowa = 946,                         /* -m3dnowa */
  OPT_m64 = 947,                             /* -m64 */
  OPT_m80387 = 948,                          /* -m80387 */
  OPT_m8bit_idiv = 949,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 950,              /* -m96bit-long-double */
  OPT_mabi_ = 951,                           /* -mabi= */
  OPT_mabm = 952,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 953,       /* -maccumulate-outgoing-args */
  OPT_maes = 954,                            /* -maes */
  OPT_malign_double = 955,                   /* -malign-double */
  OPT_malign_functions_ = 956,               /* -malign-functions= */
  OPT_malign_jumps_ = 957,                   /* -malign-jumps= */
  OPT_malign_loops_ = 958,                   /* -malign-loops= */
  OPT_malign_stringops = 959,                /* -malign-stringops */
  OPT_mandroid = 960,                        /* -mandroid */
  OPT_march_ = 961,                          /* -march= */
  OPT_masm_ = 962,                           /* -masm= */
  OPT_mavx = 963,                            /* -mavx */
  OPT_mavx256_split_unaligned_load = 964,    /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 965,   /* -mavx256-split-unaligned-store */
  OPT_mbionic = 966,                         /* -mbionic */
  OPT_mbmi = 967,                            /* -mbmi */
  OPT_mbranch_cost_ = 968,                   /* -mbranch-cost= */
  OPT_mcld = 969,                            /* -mcld */
  OPT_mcmodel_ = 970,                        /* -mcmodel= */
  /* OPT_mcpu_ = 971, */                     /* -mcpu= */
  OPT_mcrc32 = 972,                          /* -mcrc32 */
  OPT_mcx16 = 973,                           /* -mcx16 */
  OPT_mdispatch_scheduler = 974,             /* -mdispatch-scheduler */
  OPT_mf16c = 975,                           /* -mf16c */
  OPT_mfancy_math_387 = 976,                 /* -mfancy-math-387 */
  OPT_mfentry = 977,                         /* -mfentry */
  OPT_mfma = 978,                            /* -mfma */
  OPT_mfma4 = 979,                           /* -mfma4 */
  OPT_mforce_drap = 980,                     /* -mforce-drap */
  OPT_mfp_ret_in_387 = 981,                  /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 982,                        /* -mfpmath= */
  OPT_mfsgsbase = 983,                       /* -mfsgsbase */
  /* OPT_mfused_madd = 984, */               /* -mfused-madd */
  OPT_mglibc = 985,                          /* -mglibc */
  OPT_mhard_float = 986,                     /* -mhard-float */
  OPT_mieee_fp = 987,                        /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 988,       /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 989,           /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 990,   /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 991, */             /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 992,          /* -mlarge-data-threshold= */
  OPT_mlwp = 993,                            /* -mlwp */
  OPT_mmmx = 994,                            /* -mmmx */
  OPT_mmovbe = 995,                          /* -mmovbe */
  OPT_mms_bitfields = 996,                   /* -mms-bitfields */
  OPT_mno_align_stringops = 997,             /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 998,              /* -mno-fancy-math-387 */
  OPT_mno_push_args = 999,                   /* -mno-push-args */
  OPT_mno_red_zone = 1000,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1001,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1002,       /* -momit-leaf-frame-pointer */
  OPT_mpc = 1003,                            /* -mpc */
  OPT_mpclmul = 1004,                        /* -mpclmul */
  OPT_mpopcnt = 1005,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1006,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1007,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1008,                     /* -mpush-args */
  OPT_mrdrnd = 1009,                         /* -mrdrnd */
  OPT_mrecip = 1010,                         /* -mrecip */
  OPT_mred_zone = 1011,                      /* -mred-zone */
  OPT_mregparm_ = 1012,                      /* -mregparm= */
  OPT_mrtd = 1013,                           /* -mrtd */
  OPT_msahf = 1014,                          /* -msahf */
  OPT_msoft_float = 1015,                    /* -msoft-float */
  OPT_msse = 1016,                           /* -msse */
  OPT_msse2 = 1017,                          /* -msse2 */
  OPT_msse2avx = 1018,                       /* -msse2avx */
  OPT_msse3 = 1019,                          /* -msse3 */
  OPT_msse4 = 1020,                          /* -msse4 */
  OPT_msse4_1 = 1021,                        /* -msse4.1 */
  OPT_msse4_2 = 1022,                        /* -msse4.2 */
  OPT_msse4a = 1023,                         /* -msse4a */
  /* OPT_msse5 = 1024, */                    /* -msse5 */
  OPT_msseregparm = 1025,                    /* -msseregparm */
  OPT_mssse3 = 1026,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1027,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1028,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1029,            /* -mstringop-strategy= */
  OPT_mtbm = 1030,                           /* -mtbm */
  OPT_mtls_dialect_ = 1031,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1032,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1033,                         /* -mtune= */
  OPT_muclibc = 1034,                        /* -muclibc */
  OPT_mveclibabi_ = 1035,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1036,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1037,                    /* -mvzeroupper */
  OPT_mxop = 1038,                           /* -mxop */
  OPT_n = 1039,                              /* -n */
